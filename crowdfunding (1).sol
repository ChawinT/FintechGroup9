...
contract Crowdfunding {
    ...
    function releaseFunds(uint256 _id, uint256 _stage) public payable {
        ...
        if (_stage == 2) { // If the campaign cannot start, return the funds donated by the donor to the donor
            ...
            campaign.amountCollected = 0;
        } else if (_stage == 5) { // If the campaign can be completed in the end, the original funds and expected interest will be returned to the donor within 30 days after the end of the project
            ...
            campaign.amountCollected = 0;
        } else if (_stage == 4) { // If the campaign is interrupted, the remaining funds will be returned to the donor in proportion to the donation
